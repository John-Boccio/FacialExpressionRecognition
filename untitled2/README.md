#  2D \& 3D Face Alignment (and a dataset of 230,000 3D facial landmarks)
...
**Training code: <https://github.com/MuhammadHussain3/FaceAlignmentTraining>**

** Python code available: <https://github.com/MuhammadHussain3/facealignment>**
...
Clone the github repository and install all the dependencies mentioned above.

```bash
git  clone https://github.com/MuhammadHussain3/facealignment
cd  facealignment
```
...
```bash
nvidia-docker run -it MuhammadHussain3/facealignment-torch
```
