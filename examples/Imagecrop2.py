...
class FaceCropper(object):
    ...
    def generate(self, image_path, show_result):
        img = cv2.imread(r"C:\Users\Owner\PycharmProjects\untitled2\test\assets\brood.jfif")
        if (img is None):
        ...
        for (x, y, w, h) in faces:
            ...
            i += 1
            cv2.imwrite(r"C:\Users\Owner\PycharmProjects\untitled2\test\assets\croppedimage.jpg" % i, lastimg)
